...
C                      variable and write to active file
      CHARACTER*(*) active_var_file
      Real*8     active_var(1-OLx:sNx+OLx,nSx,nSy)
      Real*8     g_active_var(1-OLx:sNx+OLx,nSx,nSy)
      INTEGER iRec
      INTEGER myOptimIter
      INTEGER myThid
      LOGICAL doglobalread
...
C                      variable and write to active file
      CHARACTER*(*) active_var_file
      Real*8     active_var(1-OLy:sNy+OLy,nSx,nSy)
      Real*8     g_active_var(1-OLy:sNy+OLy,nSx,nSy)
      INTEGER iRec
      INTEGER myOptimIter
      INTEGER myThid
      LOGICAL doglobalread
