...
C
C  Differentiation of do_atmospheric_phys in reverse (adjoint) mode:
C   gradient     of useful results: theta salt rhoinsitu
C   with respect to varying inputs: theta salt rhoinsitu
C
C
C
C
...
C     !INTERFACE:
      SUBROUTINE DO_ATMOSPHERIC_PHYS_B(mytime, myiter, mythid)
      IMPLICIT NONE
C     == Global variables ===
CBOP
C    !ROUTINE: SIZE.h
