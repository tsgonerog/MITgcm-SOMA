...
C
C  Differentiation of ctrl_init_variables in reverse (adjoint) mode:
...
C     !INTERFACE:
      SUBROUTINE CTRL_INIT_VARIABLES_B(mythid)
      IMPLICIT NONE
C     == Global variables ===
CBOP
...
C
     ...
     +                   maxctrltim2d)
      CALL CTRL_MAP_INI_GENTIM2D_B(mythid)
     ...
     +                   maxctrlarr3d)
      ...
      CALL CTRL_MAP_INI_GENARR_B(mythid)
      END
