...
C     myThid :: my Thread Id number
      INTEGER NrIn, myThid
      Real*8 g_FieldFwd(1-OLx:sNx+OLx,1-OLy:sNy+OLy,NrIn)
...
C     myThid :: my Thread Id number
      INTEGER NrIn, myThid
      Real*8 g_FieldFwd(1-OLx:sNx+OLx,1-OLy:sNy+OLy,NrIn,nSx,nSy)
