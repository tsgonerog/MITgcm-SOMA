...
C
C  Differentiation of exch_uv_xy_rs in reverse (adjoint) mode:
...
C
C     !INTERFACE:
      SUBROUTINE EXCH_UV_XY_RS_B(uphi, uphib, vphi, vphib, withsigns, 
     +                           mythid)
      IMPLICIT NONE
C
C     === Global data ===
...
C     myThid    :: my Thread Id. number
      ...
      REAL*8 uphib(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 vphi(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      REAL*8 vphib(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      LOGICAL withsigns
      INTEGER mythid
C
C     !LOCAL VARIABLES:
...
C     exchWidth[XY]  :: Extent of regions that will be exchanged.
      ...
      EXTERNAL EXCH1_UV_RS_CUBE
      EXTERNAL EXCH1_UV_RS_CUBE_B
      EXTERNAL EXCH1_RS
      EXTERNAL EXCH1_RS_B
CEOP
C
C
      ...
      IF (usecubedsphereexchange) THEN
        CALL EXCH1_UV_RS_CUBE_B(uphi, uphib, vphi, vphib, withsigns, olw
     +                          , ole, ols, oln, mynz, exchwidthx, 
     +                          exchwidthy, exch_update_corners, mythid)
      ELSE
        CALL EXCH1_RS_B(vphi, vphib, olw, ole, ols, oln, mynz, 
     +                  exchwidthx, exchwidthy, exch_update_corners, 
     +                  mythid)
        CALL EXCH1_RS_B(uphi, uphib, olw, ole, ols, oln, mynz, 
     +                  exchwidthx, exchwidthy, exch_update_corners, 
     +                  mythid)
      END IF
      END
