...
C
C  Differentiation of mom_calc_absvort3 in reverse (adjoint) mode:
C   gradient     of useful results: vort3 omega3
C   with respect to varying inputs: vort3
C
C
C
C
...
C
C
      SUBROUTINE MOM_CALC_ABSVORT3_B(bi, bj, k, vort3, vort3b, omega3, 
     +                               omega3b, mythid)
      IMPLICIT NONE
...
C
      ...
      DO j=sny+oly,1-oly,-1
        DO i=snx+olx,1-olx,-1
          vort3b(i, j) = vort3b(i, j) + nonlinfac*omega3b(i, j)
          omega3b(i, j) = 0.D0
        ENDDO
      ENDDO
      END
