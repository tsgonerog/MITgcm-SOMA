...
C
C  Differentiation of packages_init_variables in reverse (adjoint) mode:
C   gradient     of useful results: xx_gentim2d_dummy etan theta
C                salt
...
C     !INTERFACE:
      SUBROUTINE PACKAGES_INIT_VARIABLES_B(mythid)
      IMPLICIT NONE
C     === Global variables ===
CBOP
C    !ROUTINE: SIZE.h
...
C     myThid  :: my Thread Id number
      ...
      EXTERNAL DIAGNOSTICS_INIT_VARIA
      EXTERNAL DEBUG_CALL
...
C
     ...
     +                   maxctrltim2d)
      ...
      CALL CTRL_INIT_VARIABLES_B(mythid)
      END
