...
C
C  Differentiation of mom_calc_tension in reverse (adjoint) mode:
C   gradient     of useful results: vfld ufld tension
...
C
C !INTERFACE: ==========================================================
      SUBROUTINE MOM_CALC_TENSION_B(bi, bj, k, ufld, ufldb, vfld, vfldb
...
C  i,j                  :: loop indices
      ...
      DO j=sny+oly-1,1-oly,-1
        DO i=snx+olx-1,1-olx,-1
          tempb = recip_ra(i, j, bi, bj)*recip_deepfacc(k)*tensionb(i, j
     +      )
          tensionb(i, j) = 0.D0
