...
C
C  Differentiation of gad_grad_x in reverse (adjoint) mode:
C   gradient     of useful results: tracer dtdx
C   with respect to varying inputs: tracer dtdx
C
C
C
C
...
C
C !INTERFACE: ==========================================================
      SUBROUTINE GAD_GRAD_X_B(bi, bj, k, xa, tracer, tracerb, dtdx, 
     +                        dtdxb, mythid)
      IMPLICIT NONE
CBOP
C    !ROUTINE: SIZE.h
...
C--   Internal exchange for calculations in X
     ...
     +      sqcosfacu(j, bi, bj)*dtdxb(i, j)
      ...
      IF (branch .NE. 0) CALL FILL_CS_CORNER_TR_RL_B(1, .false., tracer
     +                                               , tracerb, bi, bj, 
     +                                               mythid)
      END
