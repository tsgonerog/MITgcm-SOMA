...
C
C  Differentiation of exch_uv_3d_rl in reverse (adjoint) mode:
C   gradient     of useful results: uphi vphi
C   with respect to varying inputs: uphi vphi
C
C
C
C
...
C
C     !INTERFACE:
      SUBROUTINE EXCH_UV_3D_RL_B(uphi, uphib, vphi, vphib, withsigns, 
     +                           mynz, mythid)
      IMPLICIT NONE
C
C     === Global data ===
...
C     myThid    :: my Thread Id. number
      ...
      REAL*8 uphib(1-olx:snx+olx, 1-oly:sny+oly, mynz, nsx, nsy)
      REAL*8 vphi(1-olx:snx+olx, 1-oly:sny+oly, mynz, nsx, nsy)
      REAL*8 vphib(1-olx:snx+olx, 1-oly:sny+oly, mynz, nsx, nsy)
      LOGICAL withsigns
      INTEGER mythid
C
C     !LOCAL VARIABLES:
...
C     exchWidth[XY]  :: Extent of regions that will be exchanged.
      ...
      EXTERNAL EXCH1_UV_RL_CUBE
      EXTERNAL EXCH1_UV_RL_CUBE_B
      EXTERNAL EXCH1_RL
      EXTERNAL EXCH1_RL_B
CEOP
C
C
      ...
      IF (usecubedsphereexchange) THEN
        CALL EXCH1_UV_RL_CUBE_B(uphi, uphib, vphi, vphib, withsigns, olw
     +                          , ole, ols, oln, mynz, exchwidthx, 
     +                          exchwidthy, exch_update_corners, mythid)
      ELSE
        CALL EXCH1_RL_B(vphi, vphib, olw, ole, ols, oln, mynz, 
     +                  exchwidthx, exchwidthy, exch_update_corners, 
     +                  mythid)
        CALL EXCH1_RL_B(uphi, uphib, olw, ole, ols, oln, mynz, 
     +                  exchwidthx, exchwidthy, exch_update_corners, 
     +                  mythid)
      END IF
      END
