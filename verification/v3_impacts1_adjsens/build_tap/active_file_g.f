...
C     myThid         :: thread number for this instance
      ...
      Real*8     g_active_var(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      INTEGER iRec
      LOGICAL doglobalread
      LOGICAL lAdInit
      INTEGER myOptimIter
      INTEGER myThid
      Real*8     dummy, g_dummy
...
C     myThid         :: thread number for this instance
      ...
      Real*8 g_active_var(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      INTEGER iRec
      LOGICAL doglobalread
      LOGICAL lAdInit
      INTEGER myOptimIter
...
C     myThid         :: thread number for this instance
      CHARACTER*(*) active_var_file
      Real*8     active_var(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8     g_active_var(1-OLx:sNx+OLx,Nr,nSx,nSy)
      INTEGER iRec
      LOGICAL doglobalread
      LOGICAL lAdInit
      INTEGER myOptimIter
...
C     myThid         :: thread number for this instance
      CHARACTER*(*) active_var_file
      Real*8     active_var(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8     g_active_var(1-OLy:sNy+OLy,Nr,nSx,nSy)
      INTEGER iRec
      LOGICAL doglobalread
      LOGICAL lAdInit
      INTEGER myOptimIter
