...
C     !INPUT/OUTPUT PARAMETERS:
      INTEGER nnzloc
      Real*8 fld   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nnzloc,nSx,nSy)
      Real*8 fill_value
      INTEGER myThid
...
C     !INPUT/OUTPUT PARAMETERS:
      INTEGER nzIn, nzOut
      Real*8 fldIn (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nzIn,nSx,nSy)
      Real*8 fldOut(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nzOut,nSx,nSy)
      INTEGER myThid
...
C     !DESCRIPTION: \bv
C     copy a field to another array, switching from Real*8 to Real*8
C     \ev
