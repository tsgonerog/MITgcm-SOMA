...
C     !LOCAL VARIABLES:
      ...
      Real*8 log10initval
      Real*8 ln10
      Real*8 xx_gen  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
...
C     !INPUT/OUTPUT PARAMETERS:
      Real*8     fld(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      INTEGER iarr
      INTEGER myThid
...
C     !LOCAL VARIABLES:
      ...
      Real*8 log10initval
      Real*8 ln10
      Real*8 xx_gen(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      CHARACTER*(MAX_LEN_FNAM) fnamegenIn
      CHARACTER*(MAX_LEN_FNAM) fnamegenOut
      CHARACTER*(MAX_LEN_FNAM) fnamebase
      INTEGER ilgen
