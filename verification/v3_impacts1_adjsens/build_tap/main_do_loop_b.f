...
C
C  Differentiation of main_do_loop in reverse (adjoint) mode:
...
C     !INTERFACE:
      SUBROUTINE MAIN_DO_LOOP_B(iloop, mytime, myiter, mythid)
      IMPLICIT NONE
C     == Global variables ==
CBOP
C    !ROUTINE: SIZE.h
...
C
      ...
      CALL PUSHREAL8ARRAY(surfaceforcings, (snx+2*olx)*(sny+2*oly)*nsx*
     +                    nsy)
      CALL PUSHREAL8ARRAY(surfaceforcingt, (snx+2*olx)*(sny+2*oly)*nsx*
     +                    nsy)
      CALL PUSHREAL8ARRAY(surfaceforcingv, (snx+2*olx)*(sny+2*oly)*nsx*
     +                    nsy)
      CALL PUSHREAL8ARRAY(surfaceforcingu, (snx+2*olx)*(sny+2*oly)*nsx*
     +                    nsy)
      ...
      CALL PUSHREAL8ARRAY(ivdconvcount, (snx+2*olx)*(sny+2*oly)*nr*nsx*
     +                    nsy)
...
C
     ...
     +                   maxctrltim2d)
      ...
      CALL POPREAL8ARRAY(ivdconvcount, (snx+2*olx)*(sny+2*oly)*nr*nsx*
     +                   nsy)
      ...
      CALL POPREAL8ARRAY(surfaceforcingu, (snx+2*olx)*(sny+2*oly)*nsx*
     +                   nsy)
      CALL POPREAL8ARRAY(surfaceforcingv, (snx+2*olx)*(sny+2*oly)*nsx*
     +                   nsy)
      CALL POPREAL8ARRAY(surfaceforcingt, (snx+2*olx)*(sny+2*oly)*nsx*
     +                   nsy)
      CALL POPREAL8ARRAY(surfaceforcings, (snx+2*olx)*(sny+2*oly)*nsx*
     +                   nsy)
      ...
      CALL FORWARD_STEP_B(iloop, mytime, myiter, mythid)
      END
