...
C     ==================================================================
C     o Read an active 3D Real*8 variable from file.
...
C     myThid         :: thread number for this instance
      ...
      INTEGER  myNr
      Real*8      active_var(1-OLx:sNx+OLx,1-OLy:sNy+OLy,myNr,nSx,nSy)
      LOGICAL  globalFile
...
C     !LOCAL VARIABLES:
      ...
      LOGICAL w_globFile
      Real*8  dummyRS(1)
      Real*8  active_data_t(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
CEOP
          ...
          DO bj = myByLo(myThid), myByHi(myThid)
           DO bi = myBxLo(myThid), myBxHi(myThid)
            DO k = 1, myNr
             DO j=1,sNy
              DO i=1,sNx
                active_data_t(i,j,k,bi,bj) = 0.D0
              ENDDO
             ENDDO
            ENDDO
           ENDDO
...
C     ==================================================================
C     o Read an active 1D Real*8 vector from file.
...
C     !LOCAL VARIABLES:
      ...
      INTEGER ioUnit
      Real*8  dummyRS(1)
      Real*8  active_data_t(active_var_length)
CEOP
...
C     ==================================================================
C     o Write an active 3D Real*8 variable to a file.
C     started: Christian Eckert eckert@mit.edu    Jan-1999
C     ==================================================================
C     SUBROUTINE ACTIVE_WRITE_3D_RL
C     ==================================================================
...
C     ==================================================================
C     o Write an active 1D Real*8 vector from file.
