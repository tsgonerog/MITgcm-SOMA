...
C
C  Differentiation of freeze_surface in reverse (adjoint) mode:
C   gradient     of useful results: theta
...
C     !INTERFACE:
      SUBROUTINE FREEZE_SURFACE_B(mytime, myiter, mythid)
      IMPLICIT NONE
C     == Global variables ==
CBOP
C    !ROUTINE: SIZE.h
        ...
        DO bi=mybxhi(mythid),mybxlo(mythid),-1
          DO j=sny+oly,1-oly,-1
            DO i=snx+olx,1-olx,-1
              ...
              IF (branch .NE. 0) thetab(i, j, k, bi, bj) = 0.D0
            ENDDO
          ENDDO
        ENDDO
      ENDDO
