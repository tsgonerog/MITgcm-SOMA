...
C
C     Generic version for each array type (Real*8 or Real*8).
C     Note: the Real*8 version can replace the 4 x 2 shape-specific
...
C     ==================================================================
C     o Read an active (Real*8) variable from file (generic version).
...
C     ==================================================================
C     o Write an active (Real*8) variable from file (generic version).
C     Accept active variable of various (XY,XZ,YZ) shape and level
C     number, according to arguments arrShape and myNr.
C     ==================================================================
C     \ev
