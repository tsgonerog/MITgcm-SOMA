...
C
C  Differentiation of mom_calc_visc in reverse (adjoint) mode:
C   gradient     of useful results: visca4_d ke visca4_z hdiv viscah_d
C                tension viscah_z
C   with respect to varying inputs: ke hdiv strain tension vort3
C
C
C
C
...
C
C     !INTERFACE:
      SUBROUTINE MOM_CALC_VISC_B(bi, bj, k, viscah_z, viscah_zb, 
     +                           viscah_d, viscah_db, visca4_z, 
     +                           visca4_zb, visca4_d, visca4_db, hdiv, 
     +                           hdivb, vort3, vort3b, tension, tensionb
     +                           , strain, strainb, stretching, ke, keb
     +                           , hfacz, mythid)
      IMPLICIT NONE
C
C     == Global variables ==
...
C     useVariableVisc   :: variable (in space or time) viscosity is used
      COMMON /mom_visc_par_l/ useharmonicvisc, usebiharmonicvisc, 
     +usevariablevisc
      LOGICAL useharmonicvisc, usebiharmonicvisc, usevariablevisc
C
      COMMON /mom_visc_length/ l2_d, l2_z, l3_d, l3_z, l4rdt_d, l4rdt_z
...
C     myThid               :: my thread Id number
      ...
      REAL*8 viscah_zb(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 viscah_d(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 viscah_db(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 visca4_z(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 visca4_zb(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 visca4_d(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 visca4_db(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 hdiv(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 hdivb(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 vort3(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 vort3b(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 tension(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 tensionb(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 strain(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 strainb(1-olx:snx+olx, 1-oly:sny+oly)
...
C     !LOCAL VARIABLES:
      ...
      REAL*8 viscah_zminb(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 viscah_dmin(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 viscah_dminb(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 visca4_zmin(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 visca4_zminb(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 visca4_dmin(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 visca4_dminb(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 viscah_zlth(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 viscah_zlthb(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 viscah_dlth(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 viscah_dlthb(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 visca4_zlth(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 visca4_zlthb(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 visca4_dlth(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 visca4_dlthb(1-olx:snx+olx, 1-oly:sny+oly)
      ...
      REAL*8 viscah_zsmgb(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 viscah_dsmg(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 viscah_dsmgb(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 visca4_zsmg(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 visca4_zsmgb(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 visca4_dsmg(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 visca4_dsmgb(1-olx:snx+olx, 1-oly:sny+oly)
      REAL*8 sqargah, sqarga4, sqargahd, sqarga4d, sqargsmag
      REAL*8 sqargahb, sqarga4b, sqargsmagb
...
C
     ...
     +  viscc4leith .NE. 0.) .OR. viscc4leithd .NE. 0.) .OR. calcleithqg
C
...
C        to compute d/dx(hDiv), fill corners with appropriate values:
        ...
        DO j=2-oly,sny+oly-1
          DO i=2-olx,snx+olx-1
            divdx(i, j) = (hdiv(i, j)-hdiv(i-1, j))*recip_dxc(i, j, bi, 
     +        bj)*recip_deepfacc(k)
          ENDDO
        ENDDO
C
...
C        to compute d/dy(hDiv), fill corners with appropriate values:
        ...
        DO j=2-oly,sny+oly-1
          DO i=2-olx,snx+olx-1
            divdy(i, j) = (hdiv(i, j)-hdiv(i, j-1))*recip_dyc(i, j, bi, 
     +        bj)*recip_deepfacc(k)
          ENDDO
        ENDDO
C
...
C-       gradient in x direction:
     ...
     +        , bj)*recip_deepfacc(k)*masks(i, j, k, bi, bj)
          ENDDO
        ENDDO
C-       gradient in y direction:
        DO j=2-oly,sny+oly-1
     ...
     +        , bj)*recip_deepfacc(k)*maskw(i, j, k, bi, bj)
          ENDDO
        ENDDO
        CALL PUSHCONTROL1B(1)
      ELSE
...
C This is the vector magnitude of the vorticity gradient squared
     ...
     +        vrtdx(i, j)+(vrtdy(i+1, j)*vrtdy(i+1, j)+vrtdy(i, j)*vrtdy
     +        (i, j)))
C
C This is the vector magnitude of grad (div.v) squared
C Using it in Leith serves to damp instabilities in w.
            grddiv = 0.25d0*(divdx(i+1, j)*divdx(i+1, j)+divdx(i, j)*
     +        divdx(i, j)+(divdy(i, j+1)*divdy(i, j+1)+divdy(i, j)*divdy
     +        (i, j)))
C
...
C Avoid derivative of SQRT(0)
            IF (sqargah .GT. 0.d0) THEN
              CALL PUSHREAL8(sqargah)
              sqargah = SQRT(sqargah)
              CALL PUSHCONTROL1B(0)
            ELSE
              CALL PUSHCONTROL1B(1)
            END IF
            IF (sqarga4 .GT. 0.d0) THEN
              CALL PUSHREAL8(sqarga4)
...
C
          IF (calcsmag) THEN
            sqargsmag = tension(i, j)**2 + 0.25d0*(strain(i+1, j)**2+
     +        strain(i, j+1)**2+strain(i, j)**2+strain(i+1, j+1)**2)
C Avoid derivative of SQRT(0)
            IF (sqargsmag .GT. 0.d0) THEN
              CALL PUSHREAL8(sqargsmag)
...
C  Harmonic on Div.u points
     ...
     +      viscah_dsmg(i, j)
          IF (viscahgridmin*l2rdt .LT. uscl) THEN
            viscah_dmin(i, j) = uscl
            CALL PUSHCONTROL1B(0)
          ELSE
            viscah_dmin(i, j) = viscahgridmin*l2rdt
            CALL PUSHCONTROL1B(1)
          END IF
          IF (viscah_dmin(i, j) .LT. alin) THEN
            viscah_d(i, j) = alin
            CALL PUSHCONTROL1B(0)
          ELSE
            viscah_d(i, j) = viscah_dmin(i, j)
            CALL PUSHCONTROL1B(1)
          END IF
          IF (viscahgridmax*l2rdt .GT. viscahmax) THEN
            viscah_dmax(i, j) = viscahmax
          ELSE
            viscah_dmax(i, j) = viscahgridmax*l2rdt
          END IF
          IF (viscah_dmax(i, j) .GT. viscah_d(i, j)) THEN
            CALL PUSHCONTROL1B(0)
          ELSE
            CALL PUSHCONTROL1B(1)
          END IF
...
C  BiHarmonic on Div.u points
     ...
     +      visca4_dsmg(i, j)
          IF (visca4gridmin*l4rdt .LT. u4scl) THEN
            visca4_dmin(i, j) = u4scl
            CALL PUSHCONTROL1B(0)
          ELSE
            visca4_dmin(i, j) = visca4gridmin*l4rdt
            CALL PUSHCONTROL1B(1)
          END IF
          IF (visca4_dmin(i, j) .LT. alin) THEN
            visca4_d(i, j) = alin
            CALL PUSHCONTROL1B(0)
          ELSE
            visca4_d(i, j) = visca4_dmin(i, j)
            CALL PUSHCONTROL1B(1)
          END IF
          IF (visca4gridmax*l4rdt .GT. visca4max) THEN
            visca4_dmax(i, j) = visca4max
          ELSE
            visca4_dmax(i, j) = visca4gridmax*l4rdt
          END IF
          IF (visca4_dmax(i, j) .GT. visca4_d(i, j)) THEN
            CALL PUSHCONTROL1B(0)
          ELSE
            CALL PUSHCONTROL1B(1)
          END IF
...
C This is the vector magnitude of the vorticity gradient squared
     ...
     +        vrtdx(i, j)+(vrtdy(i, j-1)*vrtdy(i, j-1)+vrtdy(i, j)*vrtdy
     +        (i, j)))
C
C This is the vector magnitude of grad(div.v) squared
            grddiv = 0.25d0*(divdx(i, j-1)*divdx(i, j-1)+divdx(i, j)*
     +        divdx(i, j)+(divdy(i-1, j)*divdy(i-1, j)+divdy(i, j)*divdy
     +        (i, j)))
C
            sqargah = leith2fac*grdvrt + leithd2fac*grddiv
            sqarga4 = leith4fac*grdvrt + leithd4fac*grddiv
...
C
          IF (calcsmag) THEN
            sqargsmag = strain(i, j)**2 + 0.25d0*(tension(i, j)**2+
     +        tension(i, j-1)**2+tension(i-1, j)**2+tension(i-1, j-1)**2
     +        )
C Avoid derivative of SQRT(0)
            IF (sqargsmag .GT. 0.d0) THEN
              CALL PUSHREAL8(sqargsmag)
...
C  Harmonic on Zeta points
     ...
     +      viscah_zsmg(i, j)
          IF (viscahgridmin*l2rdt .LT. uscl) THEN
            viscah_zmin(i, j) = uscl
            CALL PUSHCONTROL1B(0)
          ELSE
            viscah_zmin(i, j) = viscahgridmin*l2rdt
            CALL PUSHCONTROL1B(1)
          END IF
          IF (viscah_zmin(i, j) .LT. alin) THEN
            viscah_z(i, j) = alin
            CALL PUSHCONTROL1B(0)
          ELSE
            viscah_z(i, j) = viscah_zmin(i, j)
            CALL PUSHCONTROL1B(1)
          END IF
          IF (viscahgridmax*l2rdt .GT. viscahmax) THEN
            viscah_zmax(i, j) = viscahmax
          ELSE
            viscah_zmax(i, j) = viscahgridmax*l2rdt
          END IF
          IF (viscah_zmax(i, j) .GT. viscah_z(i, j)) THEN
            CALL PUSHCONTROL1B(0)
          ELSE
            CALL PUSHCONTROL1B(1)
          END IF
...
C  BiHarmonic on Zeta points
     ...
     +      visca4_zsmg(i, j)
          IF (visca4gridmin*l4rdt .LT. u4scl) THEN
            visca4_zmin(i, j) = u4scl
            CALL PUSHCONTROL1B(0)
          ELSE
            visca4_zmin(i, j) = visca4gridmin*l4rdt
            CALL PUSHCONTROL1B(1)
          END IF
          IF (visca4_zmin(i, j) .LT. alin) THEN
            visca4_z(i, j) = alin
            CALL PUSHCONTROL1B(0)
          ELSE
            visca4_z(i, j) = visca4_zmin(i, j)
            CALL PUSHCONTROL1B(1)
          END IF
          IF (visca4gridmax*l4rdt .GT. visca4max) THEN
            visca4_zmax(i, j) = visca4max
          ELSE
            visca4_zmax(i, j) = visca4gridmax*l4rdt
          END IF
          IF (visca4_zmax(i, j) .GT. visca4_z(i, j)) THEN
            CALL PUSHCONTROL1B(0)
          ELSE
            CALL PUSHCONTROL1B(1)
          END IF
      ...
      DO ii1=1-oly,oly+sny
        DO ii2=1-olx,olx+snx
          strainb(ii2, ii1) = 0.D0
        ENDDO
      ENDDO
      DO ii1=1-oly,oly+sny
        DO ii2=1-olx,olx+snx
          viscah_dlthb(ii2, ii1) = 0.D0
        ENDDO
      ENDDO
      DO ii1=1-oly,oly+sny
        DO ii2=1-olx,olx+snx
          viscah_zlthb(ii2, ii1) = 0.D0
        ENDDO
      ENDDO
      DO ii1=1-oly,oly+sny
        DO ii2=1-olx,olx+snx
          viscah_dsmgb(ii2, ii1) = 0.D0
        ENDDO
      ENDDO
      DO ii1=1-oly,oly+sny
        DO ii2=1-olx,olx+snx
          viscah_zsmgb(ii2, ii1) = 0.D0
        ENDDO
      ENDDO
      DO ii1=1-oly,oly+sny
        DO ii2=1-olx,olx+snx
          viscah_dminb(ii2, ii1) = 0.D0
        ENDDO
      ENDDO
      DO ii1=1-oly,oly+sny
        DO ii2=1-olx,olx+snx
          viscah_zminb(ii2, ii1) = 0.D0
        ENDDO
      ENDDO
      DO ii1=1-oly,oly+sny
        DO ii2=1-olx,olx+snx
      ...
      DO ii1=1-oly,oly+sny
        DO ii2=1-olx,olx+snx
          visca4_dlthb(ii2, ii1) = 0.D0
        ENDDO
      ENDDO
      DO ii1=1-oly,oly+sny
        DO ii2=1-olx,olx+snx
          visca4_zlthb(ii2, ii1) = 0.D0
        ENDDO
      ENDDO
      DO ii1=1-oly,oly+sny
        DO ii2=1-olx,olx+snx
          visca4_dsmgb(ii2, ii1) = 0.D0
        ENDDO
      ENDDO
      DO ii1=1-oly,oly+sny
        DO ii2=1-olx,olx+snx
          visca4_zsmgb(ii2, ii1) = 0.D0
        ENDDO
      ENDDO
      DO ii1=1-oly,oly+sny
        DO ii2=1-olx,olx+snx
      ...
      DO ii1=1-oly,oly+sny
        DO ii2=1-olx,olx+snx
          visca4_dminb(ii2, ii1) = 0.D0
        ENDDO
      ENDDO
      DO ii1=1-oly,oly+sny
        DO ii2=1-olx,olx+snx
          visca4_zminb(ii2, ii1) = 0.D0
        ENDDO
      ENDDO
      DO j=sny+oly-1,2-oly,-1
        DO i=snx+olx-1,2-olx,-1
          CALL POPCONTROL1B(branch)
          IF (branch .NE. 0) visca4_zb(i, j) = 0.D0
          CALL POPCONTROL1B(branch)
          IF (branch .EQ. 0) THEN
            alinb = visca4_zb(i, j)
            visca4_zb(i, j) = 0.D0
          ELSE
            visca4_zminb(i, j) = visca4_zminb(i, j) + visca4_zb(i, j)
            visca4_zb(i, j) = 0.D0
            alinb = 0.D0
          END IF
          CALL POPCONTROL1B(branch)
          IF (branch .EQ. 0) THEN
            u4sclb = visca4_zminb(i, j)
            visca4_zminb(i, j) = 0.D0
          ELSE
            visca4_zminb(i, j) = 0.D0
            u4sclb = 0.D0
          END IF
          visca4_zlthb(i, j) = visca4_zlthb(i, j) + alinb
          visca4_zsmgb(i, j) = visca4_zsmgb(i, j) + alinb
          CALL POPCONTROL1B(branch)
          IF (branch .NE. 0) viscah_zb(i, j) = 0.D0
          CALL POPCONTROL1B(branch)
          IF (branch .EQ. 0) THEN
            alinb = viscah_zb(i, j)
            viscah_zb(i, j) = 0.D0
          ELSE
            viscah_zminb(i, j) = viscah_zminb(i, j) + viscah_zb(i, j)
            viscah_zb(i, j) = 0.D0
            alinb = 0.D0
          END IF
          CALL POPCONTROL1B(branch)
          IF (branch .EQ. 0) THEN
            usclb = viscah_zminb(i, j)
            viscah_zminb(i, j) = 0.D0
          ELSE
            viscah_zminb(i, j) = 0.D0
            usclb = 0.D0
          END IF
          viscah_zlthb(i, j) = viscah_zlthb(i, j) + alinb
          viscah_zsmgb(i, j) = viscah_zsmgb(i, j) + alinb
          CALL POPCONTROL1B(branch)
          IF (branch .NE. 0) THEN
            viscah_zsmgb(i, j) = smag2fac*viscah_zsmgb(i, j) + smag4fac*
     +        l2*visca4_zsmgb(i, j)
            visca4_zsmgb(i, j) = 0.D0
            sqargsmagb = l2*viscah_zsmgb(i, j)
            viscah_zsmgb(i, j) = 0.D0
            CALL POPCONTROL1B(branch)
            IF (branch .EQ. 0) THEN
              CALL POPREAL8(sqargsmag)
              IF (sqargsmag .EQ. 0.0) THEN
                sqargsmagb = 0.D0
              ELSE
                sqargsmagb = sqargsmagb/(2.0*SQRT(sqargsmag))
              END IF
            END IF
            strainb(i, j) = strainb(i, j) + 2*strain(i, j)*sqargsmagb
            tempb = 0.25d0*sqargsmagb
            tensionb(i, j) = tensionb(i, j) + 2*tension(i, j)*tempb
            tensionb(i, j-1) = tensionb(i, j-1) + 2*tension(i, j-1)*
     +        tempb
            tensionb(i-1, j) = tensionb(i-1, j) + 2*tension(i-1, j)*
     +        tempb
            tensionb(i-1, j-1) = tensionb(i-1, j-1) + 2*tension(i-1, j-1
     +        )*tempb
          END IF
          ...
          IF (branch .EQ. 0) THEN
            l3 = l3_z(i, j, bi, bj)*deepfac3
            l5 = l2*l3
            sqarga4b = l5*visca4_zlthb(i, j)
            visca4_zlthb(i, j) = 0.D0
            sqargahb = l3*viscah_zlthb(i, j)
            viscah_zlthb(i, j) = 0.D0
            CALL POPCONTROL1B(branch)
            IF (branch .EQ. 0) THEN
              CALL POPREAL8(sqarga4)
              IF (sqarga4 .EQ. 0.0) THEN
                sqarga4b = 0.D0
              ELSE
                sqarga4b = sqarga4b/(2.0*SQRT(sqarga4))
              END IF
            END IF
            CALL POPCONTROL1B(branch)
            IF (branch .EQ. 0) THEN
              CALL POPREAL8(sqargah)
              IF (sqargah .EQ. 0.0) THEN
                sqargahb = 0.D0
              ELSE
                sqargahb = sqargahb/(2.0*SQRT(sqargah))
              END IF
            END IF
            grdvrtb = leith4fac*sqarga4b + leith2fac*sqargahb
            grddivb = leithd4fac*sqarga4b + leithd2fac*sqargahb
            tempb = 0.25d0*grddivb
            divdxb(i, j-1) = divdxb(i, j-1) + 2*divdx(i, j-1)*tempb
            divdxb(i, j) = divdxb(i, j) + 2*divdx(i, j)*tempb
            divdyb(i-1, j) = divdyb(i-1, j) + 2*divdy(i-1, j)*tempb
            divdyb(i, j) = divdyb(i, j) + 2*divdy(i, j)*tempb
            tempb = 0.25d0*grdvrtb
            vrtdxb(i-1, j) = vrtdxb(i-1, j) + 2*vrtdx(i-1, j)*tempb
            vrtdxb(i, j) = vrtdxb(i, j) + 2*vrtdx(i, j)*tempb
            vrtdyb(i, j-1) = vrtdyb(i, j-1) + 2*vrtdy(i, j-1)*tempb
            vrtdyb(i, j) = vrtdyb(i, j) + 2*vrtdy(i, j)*tempb
          ELSE IF (branch .EQ. 1) THEN
            l3 = l3_z(i, j, bi, bj)*deepfac3
            l5 = l2*l3
            grdvrtb = leith4fac*l5*visca4_zlthb(i, j) + leith2fac*l3*
     +        viscah_zlthb(i, j)
            grddivb = leithd4fac*l5*visca4_zlthb(i, j) + leithd2fac*l3*
     +        viscah_zlthb(i, j)
            visca4_zlthb(i, j) = 0.D0
            viscah_zlthb(i, j) = 0.D0
            CALL POPCONTROL1B(branch)
            ...
            CALL POPCONTROL1B(branch)
            IF (branch .EQ. 0) THEN
              divdyb(i-1, j) = divdyb(i-1, j) + y12b
            ELSE
              divdyb(i-1, j) = divdyb(i-1, j) - y12b
            END IF
            CALL POPCONTROL1B(branch)
            ...
            CALL POPCONTROL1B(branch)
            IF (branch .EQ. 0) THEN
              divdxb(i, j-1) = divdxb(i, j-1) + y10b
            ELSE
              divdxb(i, j-1) = divdxb(i, j-1) - y10b
            END IF
            CALL POPCONTROL1B(branch)
            IF (branch .EQ. 0) THEN
              divdxb(i, j) = divdxb(i, j) + x4b
            ELSE
              divdxb(i, j) = divdxb(i, j) - x4b
            END IF
            CALL POPCONTROL1B(branch)
            ...
            CALL POPCONTROL1B(branch)
            IF (branch .EQ. 0) THEN
              vrtdxb(i, j) = vrtdxb(i, j) + y7b
            ELSE
              vrtdxb(i, j) = vrtdxb(i, j) - y7b
            END IF
            CALL POPCONTROL1B(branch)
            IF (branch .EQ. 0) THEN
              vrtdxb(i-1, j) = vrtdxb(i-1, j) + x3b
            ELSE
              vrtdxb(i-1, j) = vrtdxb(i-1, j) - x3b
            END IF
          ELSE
          ...
          CALL POPCONTROL2B(branch)
          IF (branch .EQ. 0) THEN
            IF (kezpt .EQ. 0.0) THEN
              kezptb = 0.D0
            ELSE
              kezptb = l3*visca4re_max*u4sclb/(2.0*SQRT(kezpt))
            END IF
            IF (.NOT.l2*kezpt .EQ. 0.0) kezptb = kezptb + l2*
     +          viscahre_max*usclb/(2.0*SQRT(l2*kezpt))
          ELSE IF (branch .EQ. 1) THEN
            kezptb = 0.D0
          ELSE
            GOTO 100
          ...
          keb(i-1, j-1) = keb(i-1, j-1) + tempb
          keb(i-1, j) = keb(i-1, j) + tempb
          keb(i, j-1) = keb(i, j-1) + tempb
 100      CALL POPREAL8(l3)
          l2 = l2_d(i, j, bi, bj)*deepfac2c(k)
          CALL POPCONTROL1B(branch)
          IF (branch .NE. 0) visca4_db(i, j) = 0.D0
          CALL POPCONTROL1B(branch)
          IF (branch .EQ. 0) THEN
            alinb = visca4_db(i, j)
            visca4_db(i, j) = 0.D0
          ELSE
            visca4_dminb(i, j) = visca4_dminb(i, j) + visca4_db(i, j)
            visca4_db(i, j) = 0.D0
            alinb = 0.D0
          END IF
          CALL POPCONTROL1B(branch)
          IF (branch .EQ. 0) THEN
            u4sclb = visca4_dminb(i, j)
            visca4_dminb(i, j) = 0.D0
          ELSE
            visca4_dminb(i, j) = 0.D0
            u4sclb = 0.D0
          END IF
          visca4_dlthb(i, j) = visca4_dlthb(i, j) + alinb
          visca4_dsmgb(i, j) = visca4_dsmgb(i, j) + alinb
          CALL POPCONTROL1B(branch)
          IF (branch .NE. 0) viscah_db(i, j) = 0.D0
          CALL POPCONTROL1B(branch)
          IF (branch .EQ. 0) THEN
            alinb = viscah_db(i, j)
            viscah_db(i, j) = 0.D0
          ELSE
            viscah_dminb(i, j) = viscah_dminb(i, j) + viscah_db(i, j)
            viscah_db(i, j) = 0.D0
            alinb = 0.D0
          END IF
          CALL POPCONTROL1B(branch)
          IF (branch .EQ. 0) THEN
            usclb = viscah_dminb(i, j)
            viscah_dminb(i, j) = 0.D0
          ELSE
            viscah_dminb(i, j) = 0.D0
            usclb = 0.D0
          END IF
          viscah_dlthb(i, j) = viscah_dlthb(i, j) + alinb
          viscah_dsmgb(i, j) = viscah_dsmgb(i, j) + alinb
          CALL POPCONTROL1B(branch)
          IF (branch .EQ. 0) THEN
            visca4_dsmgb(i, j) = 0.D0
            viscah_dsmgb(i, j) = 0.D0
          ELSE
            viscah_dsmgb(i, j) = smag2fac*viscah_dsmgb(i, j) + smag4fac*
     +        l2*visca4_dsmgb(i, j)
            visca4_dsmgb(i, j) = 0.D0
            sqargsmagb = l2*viscah_dsmgb(i, j)
            viscah_dsmgb(i, j) = 0.D0
            CALL POPCONTROL1B(branch)
            IF (branch .EQ. 0) THEN
              CALL POPREAL8(sqargsmag)
              ...
              END IF
            END IF
            tensionb(i, j) = tensionb(i, j) + 2*tension(i, j)*sqargsmagb
            tempb = 0.25d0*sqargsmagb
            strainb(i+1, j) = strainb(i+1, j) + 2*strain(i+1, j)*tempb
            strainb(i, j+1) = strainb(i, j+1) + 2*strain(i, j+1)*tempb
            strainb(i, j) = strainb(i, j) + 2*strain(i, j)*tempb
            strainb(i+1, j+1) = strainb(i+1, j+1) + 2*strain(i+1, j+1)*
     +        tempb
          END IF
          CALL POPCONTROL2B(branch)
          IF (branch .EQ. 0) THEN
            l3 = l3_d(i, j, bi, bj)*deepfac3
            l5 = l2*l3
            sqarga4b = l5*visca4_dlthb(i, j)
            visca4_dlthb(i, j) = 0.D0
            sqargahb = l3*viscah_dlthb(i, j)
            viscah_dlthb(i, j) = 0.D0
            CALL POPCONTROL1B(branch)
            IF (branch .EQ. 0) THEN
              CALL POPREAL8(sqarga4)
              IF (sqarga4 .EQ. 0.0) THEN
            ...
            grddivb = leithd4fac*sqarga4b + leithd2fac*sqargahb
            tempb = 0.25d0*grddivb
            divdxb(i+1, j) = divdxb(i+1, j) + 2*divdx(i+1, j)*tempb
            divdxb(i, j) = divdxb(i, j) + 2*divdx(i, j)*tempb
            divdyb(i, j+1) = divdyb(i, j+1) + 2*divdy(i, j+1)*tempb
            divdyb(i, j) = divdyb(i, j) + 2*divdy(i, j)*tempb
            tempb = 0.25d0*grdvrtb
            vrtdxb(i, j+1) = vrtdxb(i, j+1) + 2*vrtdx(i, j+1)*tempb
            vrtdxb(i, j) = vrtdxb(i, j) + 2*vrtdx(i, j)*tempb
            vrtdyb(i+1, j) = vrtdyb(i+1, j) + 2*vrtdy(i+1, j)*tempb
            vrtdyb(i, j) = vrtdyb(i, j) + 2*vrtdy(i, j)*tempb
          ELSE IF (branch .EQ. 1) THEN
            l3 = l3_d(i, j, bi, bj)*deepfac3
            l5 = l2*l3
            grdvrtb = leith4fac*l5*visca4_dlthb(i, j) + leith2fac*l3*
     +        viscah_dlthb(i, j)
            grddivb = leithd4fac*l5*visca4_dlthb(i, j) + leithd2fac*l3*
     +        viscah_dlthb(i, j)
            visca4_dlthb(i, j) = 0.D0
            viscah_dlthb(i, j) = 0.D0
            CALL POPCONTROL1B(branch)
            ...
            CALL POPCONTROL1B(branch)
            IF (branch .EQ. 0) THEN
              divdxb(i, j) = divdxb(i, j) + y4b
            ELSE
              divdxb(i, j) = divdxb(i, j) - y4b
            END IF
            CALL POPCONTROL1B(branch)
            IF (branch .EQ. 0) THEN
              divdxb(i+1, j) = divdxb(i+1, j) + x2b
            ELSE
              divdxb(i+1, j) = divdxb(i+1, j) - x2b
            END IF
            CALL POPCONTROL1B(branch)
            ...
            CALL POPCONTROL1B(branch)
            IF (branch .EQ. 0) THEN
              vrtdxb(i, j) = vrtdxb(i, j) + y1b
            ELSE
              vrtdxb(i, j) = vrtdxb(i, j) - y1b
            END IF
            CALL POPCONTROL1B(branch)
            IF (branch .EQ. 0) THEN
              vrtdxb(i, j+1) = vrtdxb(i, j+1) + x1b
            ELSE
              vrtdxb(i, j+1) = vrtdxb(i, j+1) - x1b
            END IF
          ELSE
          ...
          CALL POPCONTROL1B(branch)
          IF (branch .EQ. 0) THEN
            IF (.NOT.ke(i, j) .EQ. 0.0) keb(i, j) = keb(i, j) + l3*
     +          visca4re_max*u4sclb/(2.0*SQRT(ke(i, j)))
          END IF
          CALL POPCONTROL1B(branch)
          IF (branch .EQ. 0) THEN
            IF (.NOT.l2*ke(i, j) .EQ. 0.0) keb(i, j) = keb(i, j) + l2*
     +          viscahre_max*usclb/(2.0*SQRT(l2*ke(i, j)))
          END IF
          CALL POPREAL8(l3)
          CALL POPREAL8(l2)
        ENDDO
      ...
      ELSE
        ...
        DO j=sny+oly-1,2-oly,-1
          DO i=snx+olx,2-olx,-1
            tempb = maskw(i, j, k, bi, bj)*recip_dyg(i, j, bi, bj)*
     +        recip_deepfacc(k)*vrtdyb(i, j)
            vrtdyb(i, j) = 0.D0
            vort3b(i, j+1) = vort3b(i, j+1) + tempb
            vort3b(i, j) = vort3b(i, j) - tempb
          ENDDO
        ENDDO
        DO j=sny+oly,2-oly,-1
          DO i=snx+olx-1,2-olx,-1
            tempb = masks(i, j, k, bi, bj)*recip_dxg(i, j, bi, bj)*
     +        recip_deepfacc(k)*vrtdxb(i, j)
            vrtdxb(i, j) = 0.D0
            vort3b(i+1, j) = vort3b(i+1, j) + tempb
            vort3b(i, j) = vort3b(i, j) - tempb
          ENDDO
        ENDDO
        DO j=sny+oly-1,2-oly,-1
          DO i=snx+olx-1,2-olx,-1
            tempb = recip_dyc(i, j, bi, bj)*recip_deepfacc(k)*divdyb(i, 
     +        j)
            divdyb(i, j) = 0.D0
            hdivb(i, j) = hdivb(i, j) + tempb
            hdivb(i, j-1) = hdivb(i, j-1) - tempb
          ENDDO
        ENDDO
        CALL POPCONTROL1B(branch)
        IF (branch .NE. 0) CALL FILL_CS_CORNER_TR_RL_B(2, .false., hdiv
     +                                                 , hdivb, bi, bj, 
     +                                                 mythid)
        DO j=sny+oly-1,2-oly,-1
          DO i=snx+olx-1,2-olx,-1
            tempb = recip_dxc(i, j, bi, bj)*recip_deepfacc(k)*divdxb(i, 
     +        j)
            divdxb(i, j) = 0.D0
            hdivb(i, j) = hdivb(i, j) + tempb
            hdivb(i-1, j) = hdivb(i-1, j) - tempb
          ENDDO
        ENDDO
        CALL POPCONTROL1B(branch)
        IF (branch .NE. 0) CALL FILL_CS_CORNER_TR_RL_B(1, .false., hdiv
     +                                                 , hdivb, bi, bj, 
     +                                                 mythid)
      END IF
      CALL POPCONTROL1B(branch)
