...
C
C  Differentiation of exch_uv_xyz_rl in reverse (adjoint) mode:
...
C
C     !INTERFACE:
      SUBROUTINE EXCH_UV_XYZ_RL_B(uphi, uphib, vphi, vphib, withsigns, 
     +                            mythid)
      IMPLICIT NONE
C
C     === Global data ===
...
C     myThid    :: my Thread Id. number
      ...
      REAL*8 uphib(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 vphi(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      REAL*8 vphib(1-olx:snx+olx, 1-oly:sny+oly, nr, nsx, nsy)
      LOGICAL withsigns
      INTEGER mythid
C
C     !LOCAL VARIABLES:
