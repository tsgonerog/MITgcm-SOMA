...
C
C  Differentiation of mom_vi_v_grad_ke in reverse (adjoint) mode:
C   gradient     of useful results: dkedy
C   with respect to varying inputs: ke dkedy
C
C
C
C
...
C
C
      SUBROUTINE MOM_VI_V_GRAD_KE_B(bi, bj, k, ke, keb, dkedy, dkedyb, 
     +                              mythid)
      IMPLICIT NONE
...
C     == Routine arguments ==
      ...
      REAL*8 dkedyb(1-olx:snx+olx, 1-oly:sny+oly)
      INTEGER mythid
C
C     == Local variables ==
      INTEGER i, j
