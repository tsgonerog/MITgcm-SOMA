...
C
C  Differentiation of gad_grad_y in reverse (adjoint) mode:
C   gradient     of useful results: tracer dtdy
C   with respect to varying inputs: tracer dtdy
C
C
C
C
...
C
C !INTERFACE: ==========================================================
      SUBROUTINE GAD_GRAD_Y_B(bi, bj, k, ya, tracer, tracerb, dtdy, 
     +                        dtdyb, mythid)
      IMPLICIT NONE
CBOP
C    !ROUTINE: SIZE.h
...
C--   Internal exchange for calculations in Y
     ...
     +      dtdyb(i, j)
      ...
      IF (branch .NE. 0) CALL FILL_CS_CORNER_TR_RL_B(2, .false., tracer
     +                                               , tracerb, bi, bj, 
     +                                               mythid)
      END
