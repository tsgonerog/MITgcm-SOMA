...
C
C  Differentiation of external_fields_load in reverse (adjoint) mode:
C   gradient     of useful results: fu fv qnet qsw empmr saltflux
C                sst sss pload
C   with respect to varying inputs: fu fv qnet qsw empmr saltflux
C                sst sss pload
C
C
C
...
C     !INTERFACE:
      SUBROUTINE EXTERNAL_FIELDS_LOAD_B(mytime, myiter, mythid)
      IMPLICIT NONE
C     === Global variables ===
CBOP
C    !ROUTINE: SIZE.h
