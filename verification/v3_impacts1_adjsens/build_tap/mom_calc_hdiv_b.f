...
C
C  Differentiation of mom_calc_hdiv in reverse (adjoint) mode:
C   gradient     of useful results: vfld ufld hdiv
...
C
C
      SUBROUTINE MOM_CALC_HDIV_B(bi, bj, k, hdivscheme, ufld, ufldb, 
     +                           vfld, vfldb, hdiv, hdivb, mythid)
      IMPLICIT NONE
C     *==========================================================*
C     | S/R MOM_CALC_HDIV                                        |
C     *==========================================================*
      ...
      IF (hdivscheme .EQ. 1) THEN
        DO j=sny+oly-1,1-oly,-1
          DO i=snx+olx-1,1-olx,-1
            tempb = recip_ra(i, j, bi, bj)*recip_deepfacc(k)*hdivb(i, j)
            hdivb(i, j) = 0.D0
...
C
        DO j=sny+oly-1,1-oly,-1
          DO i=snx+olx-1,1-olx,-1
            tempb = recip_ra(i, j, bi, bj)*recip_deepfacc(k)*recip_hfacc
     +        (i, j, k, bi, bj)*hdivb(i, j)
            hdivb(i, j) = 0.D0
