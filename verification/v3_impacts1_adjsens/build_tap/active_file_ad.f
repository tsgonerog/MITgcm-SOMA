...
C                       variable and write to active file
      ...
      Real*8     adactive_var(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      INTEGER iRec
      INTEGER myIter, myThid
      LOGICAL doglobalread
      LOGICAL lAdInit
C Tags for IO: ctrl input and adjoint (gradient) output
      Real*8  dummy, addummy
...
C                       variable and write to active file
      CHARACTER*(*) active_var_file
      Real*8     adactive_var(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      INTEGER iRec
      INTEGER myIter, myThid
      LOGICAL doglobalread
      LOGICAL lAdInit
...
C                       variable and write to active file
      CHARACTER*(*) active_var_file
      Real*8     adactive_var(1-OLx:sNx+OLx,Nr,nSx,nSy)
      INTEGER iRec
      INTEGER myIter, myThid
      LOGICAL doglobalread
      LOGICAL lAdInit
...
C                       variable and write to active file
      CHARACTER*(*) active_var_file
      Real*8     adactive_var(1-OLy:sNy+OLy,Nr,nSx,nSy)
      INTEGER iRec
      INTEGER myIter, myThid
      LOGICAL doglobalread
      LOGICAL lAdInit
