...
C     myThid :: my Thread Id number
      INTEGER NrIn, myThid
      Real*8 adFieldFwd(1-OLx:sNx+OLx,1-OLy:sNy+OLy,NrIn)
...
C     myThid :: my Thread Id number
      INTEGER NrIn, myThid
      Real*8 adFieldFwd(1-OLx:sNx+OLx,1-OLy:sNy+OLy,NrIn,nSx,nSy)
