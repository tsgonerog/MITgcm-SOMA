...
c     Real*8 dummyRS(1)
      Real*8 globfld3d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 globfldxz(1-OLx:sNx+OLx,Nr,nSx,nSy)
...
c       CALL MDS_WRITE_SEC_XZ( fname, filePrec, .FALSE., .FALSE.,
...
C     in ini_model_io.F if using OBCS)
        CALL WRITE_REC_XZ_RL( fname, filePrec,
     I                        Nr, globfldxz,
