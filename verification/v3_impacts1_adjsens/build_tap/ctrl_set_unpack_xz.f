...
c     == local variables ==
      ...
      Real*8     globfldxz( sNx,nSx,nPx,nSy,nPy,Nr )
      Real*8     globfld3d( sNx,nSx,nPx,sNy,nSy,nPy,Nr )
      Real*8     globmskxz( sNx,nSx,nPx,nSy,nPy,Nr,nobcs )
         ...
         do jp = 1,nPy
            do bj = jtlo,jthi
               do ip = 1,nPx
                  do bi = itlo,ithi
                     do i = imin,imax
                        globfldxz  (i,bi,ip,bj,jp,k) = 0.D0
                        globfldtmp2(i,bi,ip,bj,jp)   = 0.
                        globfldtmp3(i,bi,ip,bj,jp)   = 0.
                        do iobcs=1,nobcs
                           globmskxz(i,bi,ip,bj,jp,k,iobcs) = 0.D0
                        enddo
                     enddo
                  enddo
               enddo
...
cph)
                       ...
                       globfld3d(i,bi,ip,jj,bj,jp,kk) = 0.D0
                    endif
cph(
