...
C--   Sum all cost function contributions.
      CALL PUSHREAL8ARRAY(objf_test, nsx*nsy)
...
C
      ...
      CALL POPREAL8ARRAY(objf_test, nsx*nsy)
     ...
     +                     nsy)
        CALL POPREAL8ARRAY(cmeanuvel, (snx+2*olx)*(sny+2*oly)*nr*nsx*nsy
     +                    )
        CALL POPREAL8ARRAY(cmeanvvel, (snx+2*olx)*(sny+2*oly)*nr*nsx*nsy
     +                    )
