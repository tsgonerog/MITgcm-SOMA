...
C
C  Differentiation of gad_c4_adv_x in reverse (adjoint) mode:
C   gradient     of useful results: utrans tracer ut
C   with respect to varying inputs: utrans tracer
C
C
C
C
...
C
C !INTERFACE: ==========================================================
      SUBROUTINE GAD_C4_ADV_X_B(bi, bj, k, utrans, utransb, masklocw, 
...
C  Rjjm,Rjjp            :: second differences at i-1,i
     ...
     +      onesixth*(rjjp+rjjm))*0.5d0*utb(i, j)
          tempb = utrans(i, j)*0.5d0*utb(i, j)
          tempb0 = onesixth*0.5d0*(1.d0-maskw(i-1, j, k, bi, bj)*maskw(i
     +      +1, j, k, bi, bj))*utb(i, j)
          utb(i, j) = 0.D0
          abs0b = (rjjp-rjjm)*tempb0
          rjjpb = abs0*tempb0 - onesixth*tempb
          rjjmb = -(abs0*tempb0) - onesixth*tempb
