...
C
C  Differentiation of mom_calc_strain in reverse (adjoint) mode:
C   gradient     of useful results: vfld ufld strain
...
C
C !INTERFACE: ==========================================================
      SUBROUTINE MOM_CALC_STRAIN_B(bi, bj, k, ufld, ufldb, vfld, vfldb, 
...
C  i,j                  :: loop indices
      ...
      DO j=sny+oly,2-oly,-1
        DO i=snx+olx,2-olx,-1
          tempb = recip_raz(i, j, bi, bj)*recip_deepfacc(k)*strainb(i, j
     +      )
          strainb(i, j) = 0.D0
