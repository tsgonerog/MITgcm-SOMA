...
C Avoid derivative of SQRT(0)
          IF (sqargAh .GT.0.D0) sqargAh = SQRT(sqargAh)
          IF (sqargA4 .GT.0.D0) sqargA4 = SQRT(sqargA4)
          IF (sqargAhD .GT.0.D0) sqargAhD = SQRT(sqargAhD)
          IF (sqargA4D .GT.0.D0) sqargA4D = SQRT(sqargA4D)
...
C Avoid derivative of SQRT(0)
          IF (sqargSmag.GT.0.D0) sqargSmag = SQRT(sqargSmag)
