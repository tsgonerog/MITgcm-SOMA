...
C--     Set default values.
        ...
        do iarr = 1, maxCtrlArr2D
         ...
         genarr2dPrecond(iarr)  = 1.D0
         mult_genarr2d(iarr)    = 1.D0
         do jarr = 1, 5
           xx_genarr2d_bounds(jarr,iarr) = 0.D0
         enddo
         do jarr=1,maxCtrlProc
          xx_genarr2d_preproc(jarr,iarr)   = ' '
          xx_genarr2d_preproc_c(jarr,iarr) = ' '
          xx_genarr2d_preproc_i(jarr,iarr) = 0
          xx_genarr2d_preproc_r(jarr,iarr) = 0.D0
         enddo
        enddo
        ...
        do iarr = 1, maxCtrlArr3D
         ...
         genarr3dPrecond(iarr)  = 1.D0
         mult_genarr3d(iarr)    = 1.D0
         do jarr = 1, 5
           xx_genarr3d_bounds(jarr,iarr) = 0.D0
         enddo
         do jarr=1,maxCtrlProc
          xx_genarr3d_preproc(jarr,iarr)   = ' '
          xx_genarr3d_preproc_c(jarr,iarr) = ' '
          xx_genarr3d_preproc_i(jarr,iarr) = 0
          xx_genarr3d_preproc_r(jarr,iarr) = 0.D0
         enddo
        enddo
        ...
        do iarr = 1, maxCtrlTim2D
         ...
         do jarr=1,maxCtrlProc
          ...
          xx_gentim2d_preproc_r(jarr,iarr) = 0.D0
         enddo
         mult_gentim2d(iarr)          = 1.D0
         gentim2dPrecond(iarr)        = 1.D0
         do jarr = 1, 5
           xx_gentim2d_bounds(jarr,iarr) = 0.D0
         enddo
        enddo
...
C     !INPUT/OUTPUT PARAMETERS:
      ...
      Real*8 xx_remo_intercept, xx_remo_slope
      INTEGER myThid
