...
C
C  Differentiation of tracers_correction_step in reverse (adjoint) mode:
...
C     !INTERFACE:
      SUBROUTINE TRACERS_CORRECTION_STEP_B(mytime, myiter, mythid)
      IMPLICIT NONE
C     == Global variables ===
CBOP
C    !ROUTINE: SIZE.h
...
C--     Convectively adjust new fields to be statically stable
     ...
     +                        )
            ...
            CALL CONVECTIVE_ADJUSTMENT_B(bi, bj, mytime, myiter, mythid)
          END IF
        ENDDO
      ENDDO
      END
