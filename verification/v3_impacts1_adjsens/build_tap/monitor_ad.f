...
C     SIregFacInFw :: Factor for over shoots in FW
      Real*8 viscFacInAd, viscFacInFw
      Real*8 SIregFacInAd, SIregFacInFw
...
C--   heimbach@mit.edu 11-Jan-2001
     ...
     &                     adGuNm1, adGvNm1, adGtNm1, adGsNm1
      Real*8 adEtaN(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8 adGu(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 adGv(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 adSalt(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 adTheta(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 adUvel(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 adVvel(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 adWvel(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 adGtNm1(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 adGsNm1(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 adGuNm1(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 adGvNm1(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)

      COMMON /adDYNVARS_R_2/
     &                     adEtaH
      Real*8 adEtaH(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      ...
      Real*8  adFu       (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8  adFv       (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8  adQnet     (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8  adQsw      (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8  adEmPmR    (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8  adSaltFlux (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8  adSST      (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8  adSSS      (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8  adLambdaThetaClimRelax
     &    (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8  adLambdaSaltClimRelax
     &    (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)

      COMMON /adFFIELDS_pload/ adPload
      COMMON /adFFIELDS_sIceLoad/ adSIceLoad
      Real*8  adPload    (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8  adSIceLoad (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
...
C     !LOCAL VARIABLES:
      ...
      Real*8 dummyRL(6)
      INTEGER k
      Real*8 var2Du(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8 var2Dv(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8 var3Du(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 var3Dv(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 dumRS(1)
      Real*8 dumRL(1)
