...
C
C  Differentiation of initialise_varia in reverse (adjoint) mode:
C   gradient     of useful results: xx_gentim2d_dummy /cost_r/[0,8[
C                etan wvel theta salt etah detahdt pmepr
C   with respect to varying inputs: xx_genarr2d_dummy xx_genarr3d_dummy
C                xx_gentim2d_dummy /cost_r/[0,8[
C
C
C
C
...
C     !INTERFACE:
      SUBROUTINE INITIALISE_VARIA_B(mythid)
      IMPLICIT NONE
C     == Global variables ==
CBOP
C    !ROUTINE: SIZE.h
...
C
      ...
      DO ii1=1,nsy
        ...
        ENDDO
      ENDDO
      CALL INTEGR_CONTINUITY_B(uvel, uvelb, vvel, vvelb, starttime, 
     +                         niter0, mythid)
      CALL COST_INIT_VARIA_B(mythid)
     ...
     +                   maxctrltim2d)
      ...
      CALL PACKAGES_INIT_VARIABLES_B(mythid)
      END
