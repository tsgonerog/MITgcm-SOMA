...
C     myThid :: my Thread Id number
      INTEGER NrIn, myThid
      Real*8 minRef,maxRef,timeDamp
      Real*8 fieldRef(1-OLx:sNx+OLx,1-OLy:sNy+OLy,NrIn,nSx,nSy)
      Real*8 adfieldDamp(1-OLx:sNx+OLx,1-OLy:sNy+OLy,NrIn,nSx,nSy)
...
CEOP
     ...
     &          (fieldRef(i,j,k,bi,bj).LE.minRef) ) THEN
              facDamp=(1.D0-deltaTClock/timeDamp)
           ELSE
              facDamp=1.D0
           ENDIF
