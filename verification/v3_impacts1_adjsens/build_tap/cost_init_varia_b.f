...
C
C  Differentiation of cost_init_varia in reverse (adjoint) mode:
C   gradient     of useful results: fc
C   with respect to varying inputs: fc
C
C
C
C
...
C   ==================================================================
C
      SUBROUTINE COST_INIT_VARIA_B(mythid)
      IMPLICIT NONE
C
C     == global variables ==
C
