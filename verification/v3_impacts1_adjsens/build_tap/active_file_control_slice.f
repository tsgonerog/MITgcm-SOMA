...
C     ==================================================================
C     o Read an active XZ Real*8 variable from file.
...
C     myThid         :: thread number for this instance
      ...
      INTEGER  myNr
      Real*8      active_var(1-OLx:sNx+OLx,myNr,nSx,nSy)
      LOGICAL  globalFile
...
C     !LOCAL VARIABLES:
      ...
      LOGICAL w_globFile
      Real*8  dummyRS(1)
      Real*8  active_data_t(1-OLx:sNx+OLx,myNr,nSx,nSy)
CEOP
...
C     ==================================================================
C     o Read an active YZ Real*8 variable from file.
C     The variable *globalfile* can be used as a switch, which allows
C     to read from a global file. The adjoint files are, however, always
C     treated as tiled files.
C     started: heimbach@mit.edu 05-Mar-2001
...
C     myThid         :: thread number for this instance
      CHARACTER*(*) activeVar_file
      INTEGER  myNr
      Real*8      active_var(1-OLy:sNy+OLy,myNr,nSx,nSy)
      LOGICAL  globalFile
      LOGICAL  useCurrentDir
      LOGICAL  lAdInit
      INTEGER  iRec
...
C     !LOCAL VARIABLES:
      ...
      LOGICAL w_globFile
      Real*8  dummyRS(1)
      Real*8  active_data_t(1-OLy:sNy+OLy,myNr,nSx,nSy)
CEOP
...
C     ==================================================================
C     o Write an active XZ Real*8 variable to a file.
C     started: heimbach@mit.edu 05-Mar-2001
C     ==================================================================
C     SUBROUTINE ACTIVE_WRITE_XZ_RL
C     ==================================================================
...
C     ==================================================================
C     o Write an active YZ Real*8 variable to a file.
C     started: heimbach@mit.edu 05-Mar-2001
C     ==================================================================
C     SUBROUTINE ACTIVE_WRITE_YZ_RL
C     ==================================================================
