...
C
C  Differentiation of gad_c2_adv_r in reverse (adjoint) mode:
...
C
C !INTERFACE: ==========================================================
      SUBROUTINE GAD_C2_ADV_R_B(bi, bj, k, rtrans, rtransb, tracer, 
...
C
      ...
      ELSE
        DO j=sny+oly,1-oly,-1
          DO i=snx+olx,1-olx,-1
            tempb = maskc(i, j, km1, bi, bj)*0.5d0*wtb(i, j)
            wtb(i, j) = 0.D0
