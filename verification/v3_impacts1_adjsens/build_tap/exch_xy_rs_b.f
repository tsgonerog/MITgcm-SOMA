...
C
C  Differentiation of exch_xy_rs in reverse (adjoint) mode:
...
C
C     !INTERFACE:
      SUBROUTINE EXCH_XY_RS_B(phi, phib, mythid)
      IMPLICIT NONE
C
C     === Global data ===
CBOP
...
C     myThid :: My thread id.
      ...
      REAL*8 phib(1-olx:snx+olx, 1-oly:sny+oly, nsx, nsy)
      INTEGER mythid
C
C     !LOCAL VARIABLES:
C     == Local variables ==
...
C     exchWidth[XY]  :: Extent of regions that will be exchanged.
      ...
      EXTERNAL EXCH1_RS_CUBE
      EXTERNAL EXCH1_RS_CUBE_B
      EXTERNAL EXCH1_RS
      EXTERNAL EXCH1_RS_B
CEOP
C
C
      ...
      IF (usecubedsphereexchange) THEN
        CALL EXCH1_RS_CUBE_B(phi, phib, .false., olw, ole, ols, oln, 
     +                       mynz, exchwidthx, exchwidthy, 
     +                       exch_update_corners, mythid)
      ELSE
        CALL EXCH1_RS_B(phi, phib, olw, ole, ols, oln, mynz, exchwidthx
