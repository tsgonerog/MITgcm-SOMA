...
C
C  Differentiation of mom_u_coriolis_nh in reverse (adjoint) mode:
C   gradient     of useful results: ucoriolisterm wfld
C   with respect to varying inputs: ucoriolisterm wfld
C
C
C
C
...
C
C !INTERFACE: ==========================================================
      SUBROUTINE MOM_U_CORIOLIS_NH_B(bi, bj, k, wfld, wfldb, 
...
C  i,j                  :: loop indices
      ...
      DO j=sny+oly,1-oly,-1
        DO i=snx+olx,2-olx,-1
          tempb = gravitysign*0.5*ucoriolistermb(i, j)
          ucoriolistermb(i, j) = 0.D0
          tempb0 = fcoricos(i, j, bi, bj)*0.5*anglecosc(i, j, bi, bj)*
     +      tempb
          tempb1 = fcoricos(i-1, j, bi, bj)*0.5*anglecosc(i-1, j, bi, bj
     +      )*tempb
