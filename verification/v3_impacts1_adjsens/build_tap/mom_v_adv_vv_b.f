...
C
C  Differentiation of mom_v_adv_vv in reverse (adjoint) mode:
C   gradient     of useful results: vfld advectfluxvv
C   with respect to varying inputs: vfld vtrans advectfluxvv
C
C
C
C
...
C
C !INTERFACE: ==========================================================
      SUBROUTINE MOM_V_ADV_VV_B(bi, bj, k, vtrans, vtransb, vfld, vfldb
     +                          , advectfluxvv, advectfluxvvb, mythid)
      IMPLICIT NONE
CBOP
C    !ROUTINE: SIZE.h
C    !INTERFACE:
...
C  AdvectFluxVV         :: advective flux
      ...
      REAL*8 advectfluxvvb(1-olx:snx+olx, 1-oly:sny+oly)
C
C !LOCAL VARIABLES: ====================================================
C  i,j                  :: loop indices
      INTEGER i, j
      ...
      DO j=sny+oly-1,1-oly,-1
        DO i=snx+olx-1,1-olx,-1
          tempb = (vfld(i, j)+vfld(i, j+1))*0.25*advectfluxvvb(i, j)
          tempb0 = (vtrans(i, j)+vtrans(i, j+1))*0.25*advectfluxvvb(i, j
     +      )
          advectfluxvvb(i, j) = 0.D0
