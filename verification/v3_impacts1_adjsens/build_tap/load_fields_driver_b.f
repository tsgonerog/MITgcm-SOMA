...
C
C  Differentiation of load_fields_driver in reverse (adjoint) mode:
C   gradient     of useful results: xx_gentim2d_dummy xx_gentim2d0
C                xx_gentim2d1 xx_gentim2d fu fv qnet qsw empmr
C                saltflux sst sss pload
...
C     !INTERFACE:
      SUBROUTINE LOAD_FIELDS_DRIVER_B(mytime, myiter, mythid)
      IMPLICIT NONE
C     == Global variables ==
CBOP
C    !ROUTINE: SIZE.h
...
C
      IF (fluidiswater) THEN
        ...
        CALL EXTERNAL_FIELDS_LOAD_B(mytime, myiter, mythid)
      END IF
     ...
     +                     maxctrltim2d)
        CALL CTRL_MAP_GENTIM2D_B(mytime, myiter, mythid)
      END IF
      END
