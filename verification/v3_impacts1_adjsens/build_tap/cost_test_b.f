...
C
C  Differentiation of cost_test in reverse (adjoint) mode:
C   gradient     of useful results: objf_test
C   with respect to varying inputs: theta
C
C
C
C
...
C
      ...
      DO bj=jthi,jtlo,-1
        DO bi=ithi,itlo,-1
          DO j=sny,1,-1
            DO i=snx,1,-1
              thetab(i, j, klocout, bi, bj) = thetab(i, j, klocout, bi, 
     +          bj) + 2*theta(i, j, klocout, bi, bj)*objf_testb(bi, bj)
            ENDDO
          ENDDO
        ENDDO
      ENDDO
