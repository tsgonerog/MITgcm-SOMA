...
C========================================================================
      ...
      integer jmin,jmax
      integer imin,imax
      Real*8     globmsk  ( sNx,nSx,nPx,sNy,nSy,nPy,Nr )
          ...
          do ip = 1,nPx
           do bi = itlo,ithi
            do i = imin,imax
             ...
             globmsk    (i,bi,ip,j,bj,jp,k) = 0.D0
             globfldtmp2(i,bi,ip,j,bj,jp)   = 0.D0
             globfldtmp3(i,bi,ip,j,bj,jp)   = 0.D0
            enddo
           enddo
          enddo
         enddo
