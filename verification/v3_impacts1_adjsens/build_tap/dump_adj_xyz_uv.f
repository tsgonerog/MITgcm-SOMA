...
C !INTERFACE:
      SUBROUTINE DUMP_ADJ_XYZ_UV(
     I           u3DRS, u3DRL, uDiagName, uDumpName,
...
C     for 3-D 2-component vector field given the millions of autodiff options
...
C   u3DRS   ( RS ) :: input 3-D, u-component AD-variable field
C   u3DRL   ( RL ) :: input 3-D, u-component AD-variable field
C   uDiagName (C ) :: u-component diagnostics name
C   uDumpName (C ) :: u-component output file prefix
C   v3DRS   ( RS ) :: input 3-D, v-component AD-variable field
C   v3DRL   ( RL ) :: input 3-D, v-component AD-variable field
...
C   vCopy  ( RL )  :: copy of v-component input field
      CHARACTER*(10) suff
      Real*8 uCopy(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 vCopy(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
CEOP
