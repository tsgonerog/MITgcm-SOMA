...
C
C  Differentiation of cycle_ab_tracer in reverse (adjoint) mode:
C   gradient     of useful results: tracer tracnm1
C   with respect to varying inputs: tracnew tracer tracnm1
C
C
C
C
...
C     !INTERFACE:
      SUBROUTINE CYCLE_AB_TRACER_B(bi, bj, tracnew, tracnewb, tracer, 
     +                             tracerb, tracnm1, tracnm1b, mytime, 
     +                             myiter, mythid)
      IMPLICIT NONE
C Common
CBOP
...
C     myThid    :: my Thread Id number
      ...
      REAL*8 tracnewb(1-olx:snx+olx, 1-oly:sny+oly, nr)
      ...
      REAL*8 tracnm1b(1-olx:snx+olx, 1-oly:sny+oly, nr)
      REAL*8 mytime
      ...
      DO k=nr,1,-1
        DO j=sny+oly,1-oly,-1
          DO i=snx+olx,1-olx,-1
            tracnewb(i, j, k) = tracnewb(i, j, k) + tracerb(i, j, k)
            tracerb(i, j, k) = tracnm1b(i, j, k)
            tracnm1b(i, j, k) = 0.D0
          ENDDO
        ENDDO
      ENDDO
